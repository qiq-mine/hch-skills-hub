...
| Tool | Type | MCP | Guide |
|------|------|:---:|-------|
| **HeyGen** | AI avatars | Yes | [docs.heygen.com](https://docs.heygen.com) (本地集成指南待补充) |
| **Hyperframes** | Programmatic video | - | [hyperframes.com/docs](https://hyperframes.com/docs) (本地集成指南待补充) |
...
> [!NOTE]
> 本技能概述了 AI 与代码化视频生成的全景方案，目前以下资源待补充沉淀：
