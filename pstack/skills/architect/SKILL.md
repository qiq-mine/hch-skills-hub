...
Use your configured architect runners from `.agents/rules/pstack-models.md` (Antigravity defaults: `pro`, `flash`, `inherit`; DSH defaults: `deepseek-reasoner`, `deepseek-chat`).
